...
namespace FlenskiProject\KlickTipp;
...
class Connector {
     ...
     *
     * @return array|boolean|null A associative array <list id> => <list name>
     */
     ...
     *
     * @return object|boolean|null An object representing the Klicktipp subscription process.
     */
